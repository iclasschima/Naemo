        ...
        <About className="container-fluid">
            ...
            <Row xs={1}>
                <Col>
                    ...
                    <p>
                        ...
                        developers,	we	are	building innovative solutions in the areas of scouting, player performance,	
                        data gathering and football education.
                    </p>
                </Col>
            </Row>
            ...
            <Row id="do_div" xs={1} md={3}>
                <Col>
                    ...
                    <p>We provide data-led insights and services for sports	professionals</p>
                </Col>
                <Col>
                    <img src={market} />
                    <h6>Product Design</h6>
                    <p>Our applications are intuitive and are built	with the latest technology</p>
                </Col>
                <Col>
                    <img src={visualize} />
            ...
            <Row xs={1} md={4} id="mission_div"> 
                ...
                <Col>
                    <img src={together} id="together"/>
                    <h6>Teamwork</h6>
                
                </Col>
                <Col>
                    <img src={questions} id="questions"/>
